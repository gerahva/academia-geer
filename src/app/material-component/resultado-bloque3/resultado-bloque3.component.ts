...
@Component({
  selector: 'app-resultado-bloque3',
  templateUrl: './resultado-bloque3.component.html',
  styleUrls: ['./resultado-bloque3.component.css'],
  providers: [ExcelService]
})
export class ResultadoBloque3Component implements OnInit {
